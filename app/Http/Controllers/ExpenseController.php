...
use App\Modules\Expenses\Models\Expense;  // ← FIXED
...
class ExpenseController extends Controller
{
    ...
    {
        $expenses = Expense::with(['estate', 'payee', 'category', 'payments'])->get();
        $estates = Estate::all();
        $payees = Payee::all();
    ...
    {
        $expense->load(['estate', 'payee', 'category', 'payments']);
        $estates = Estate::all();
        $payees = Payee::all();
        $categories = ExpenseCategory::all();
    ...
    public function store(Request $request)
    {
        ...
        // Non-AJAX request - your existing code
        $validated = $request->validate([
            'estate_id' => 'required|exists:estates,id',
            'payee_id' => 'required|exists:payees,id',
            'expense_category_id' => 'required|exists:expense_categories,id',
