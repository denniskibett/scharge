...
CREATE TABLE `security` (
  ...
  KEY `security_company_id_index` (`company_id`),
  KEY `security_estate_id_index` (`estate_id`),
  CONSTRAINT `security_company_id_foreign` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE CASCADE,
  CONSTRAINT `security_estate_id_foreign` FOREIGN KEY (`estate_id`) REFERENCES `estates` (`id`) ON DELETE CASCADE,
