...
<div class="flex flex-col gap-5 p-6">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
        ...
        <div class="pt-5">
            <form action="{{ route('admin.account-managers.update', $accountManager->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select name="user_id" id="user_id" 
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ old('user_id', $accountManager->user_id) == $user->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="company_id" id="company_id" 
                            ...
                            @foreach($companies as $company)
                                <option value="{{ $company->id }}" {{ old('company_id', $accountManager->company_id) == $company->id ? 'selected' : '' }}>
                                    {{ $company->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" 
                               value="{{ old('title', $accountManager->title) }}" 
