...
<div class="container mx-auto px-4 py-6 max-w-screen-2xl">
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <a href="{{ route('staff.create') }}" class="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 transition">
    ...
    <div class="mb-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 p-3 border border-blue-200 dark:border-blue-800 flex flex-wrap items-center gap-2 text-sm">
        ...
        @endif
        <a href="{{ route('staff.index') }}" class="ml-auto text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium text-xs">
    ...
    <div class="mb-4 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-3 shadow-sm">
        <form id="filterForm" method="GET" action="{{ route('staff.index') }}" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-2">
            <div class="relative">
            ...
            <div class="flex gap-1.5">
                ...
                <a href="{{ route('staff.index') }}" class="inline-flex items-center justify-center rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition h-9 w-9" title="Clear filters">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody id="staffTableBody" class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($staff as $user)
                        @include('staff.partials._row', ['user' => $user])
                    @empty
                    <tr>
...
<script>
    ...
    function exportStaff() {
        ...
        var url = new URL('{{ route("staff.create") }}');
    ...
    function updateStats() {
        ...
        var url = new URL('{{ route("staff.index") }}');
