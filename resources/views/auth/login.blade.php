...
<html lang="en">
  ...
  >
    ...
    <!-- ===== Page Wrapper Start ===== -->
    <div
      class="relative z-1 flex h-screen w-full overflow-hidden bg-white dark:bg-gray-900"
    >
      <div
          ...
          <div>
            ...
            <div class="relative py-3 sm:py-5">
              ...
              <div class="relative flex justify-center text-sm">
                <span
                  class="bg-white p-2 text-gray-400 dark:bg-gray-900 sm:px-5 sm:py-2"
                  >Or</span
                >
              </div>
            </div>
            ...
            <div class="mt-5">
              <p
                class="text-center text-sm font-normal text-gray-700 dark:text-gray-400 sm:text-start"
              >
