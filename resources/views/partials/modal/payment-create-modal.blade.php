      ...
      <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
        ...
        <div class="space-y-2 text-sm">
          ...
          <div class="border-t border-gray-200 dark:border-gray-700 pt-2 mt-2">
            ...
            <!-- ⚠️ FIX: Hide wallet balance for M-Pesa payments -->
            <div class="flex justify-between mt-1" x-show="walletBalance !== null && form.payment_method !== 'mpesa_paybill'">
            ...
            <!-- ✅ Show M-Pesa payment info instead -->
            <div class="flex justify-between mt-1" x-show="form.payment_method === 'mpesa_paybill'">
              <span class="text-gray-700 dark:text-gray-300">Payment via:</span>
              <span class="font-semibold text-blue-600">💳 M-Pesa (Direct Payment)</span>
            </div>
          </div>
        </div>
      </div>
...
document.addEventListener('alpine:init', () => {
  Alpine.data('paymentModal', () => ({
    ...
    // ⚠️ FIX: submitForm skips wallet balance check for M-Pesa
    async submitForm() {
      this.formErrors = [];
      this.successMessage = '';
      ...
      // ⚠️ FIX: SKIP wallet balance check for M-Pesa payments
      if (this.form.payment_method !== 'mpesa_paybill') {
        // Only check wallet balance for non-M-Pesa methods
