<div>
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex items-center gap-4">
            ...
            <button onclick="window.subscriptionsInvoicesModal?.openModal({{ $planId }})" 
                ...
                <tbody>
                    @foreach($invoices as $invoice)
                        <tr class="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
                            ...
                            <td class="py-2.5 px-3 text-gray-700 dark:text-gray-300">{{ $invoice->subscription?->company?->name ?? 'N/A' }}</td>
                            ...
                            <td class="py-2.5 px-3 text-gray-600 dark:text-gray-400">{{ $invoice->due_date?->format('M d, Y') ?? 'N/A' }}</td>
                            <td class="py-2.5 px-3">
                                <div class="flex items-center gap-2">
                                    <button onclick="window.subscriptionsInvoicesModal?.openModal({{ $planId }}, {{ $invoice->id }})" 
