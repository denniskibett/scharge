  ...
  <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between border-b border-gray-200 dark:border-gray-700 px-5 py-4 gap-4">
      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        <!-- Unit Type Filter with TailAdmin dropdown styling -->
        <div class="relative">
          <select 
        ...
        <!-- Rent Range Filter with TailAdmin dropdown styling -->
        <div class="relative">
          <select 
        ...
        <!-- Search Bar with TailAdmin styling -->
        <div class="relative">
        ...
        <!-- Entries Per Page with TailAdmin dropdown styling -->
        <div class="relative">
          <select 
        ...
        <!-- Add Unit Button -->
        <button 
          @click="window.unitCreateModal?.openModal()"
      ...
      <table class="w-full table-auto">
        <thead>
          <tr class="border-b border-gray-200 dark:border-gray-800">
            ...
            <th class="p-4 text-left text-xs font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Rent (KES)</th>
            <th class="p-4 text-left text-xs font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Water (KES)</th>
            <th class="p-4 text-left text-xs font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Service (KES)</th>
            <th class="p-4 text-left text-xs font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Garbage (KES)</th>
            <th class="p-4 text-left text-xs font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Security (KES)</th>
            <th class="p-4 text-left text-xs font-medium whitespace-nowrap text-gray-500 dark:text-gray-400 cursor-pointer" @click="sortBy('total_monthly_charges')">
              <div class="flex items-center gap-1">
                <span>Total (KES)</span>
                <span class="flex flex-col gap-0.5">
            ...
            <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900">
              <td class="p-4 whitespace-nowrap">
                <div class="flex items-center gap-3">
                  <!-- Dynamic background color based on estate_id -->
                  <div class="flex-shrink-0 h-8 w-8 rounded-full flex items-center justify-center" 
                       :class="getEstateColor(unit.estate_id)">
                    <span class="text-white font-medium text-sm" x-text="getEstateInitials(unit.estate_name)"></span>
                  </div>
              ...
              <td class="p-4 whitespace-nowrap">
                <span class="text-sm font-medium" :class="getEstateTextColor(unit.estate_id)" x-text="unit.estate_name"></span>
              </td>
              ...
              <td class="p-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">
                KES <span x-text="formatCurrency(unit.water_charge || 0)"></span>
              </td>
              <td class="p-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">
                KES <span x-text="formatCurrency(unit.service_charge || 0)"></span>
              </td>
              <td class="p-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">
                KES <span x-text="formatCurrency(unit.garbage_charge || 0)"></span>
              </td>
              <td class="p-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">
                KES <span x-text="formatCurrency(unit.security_charge || 0)"></span>
              </td>
              <td class="p-4 whitespace-nowrap">
...
function unitsTable() {
    return {
        ...
        init() {
            ...
            const unitsElement = document.getElementById('units-data');
            if (unitsElement) {
                this.units = JSON.parse(unitsElement.textContent);
                console.log('Units loaded:', this.units.length);
                console.log('Sample unit data:', this.units[0]);
            }
        ...
        filterUnits() {
            ...
            if (this.activeTab === 'occupied') {
                ...
                console.log('Filtered to occupied units:', filtered.length);
            } else if (this.activeTab === 'vacant') {
                filtered = filtered.filter(unit => unit.status === 'vacant');
                console.log('Filtered to vacant units:', filtered.length);
            }
        ...
        // Get color class based on estate_id (different colors for different estates)
        ...
        // Get text color class based on estate_id (lighter version for text)
